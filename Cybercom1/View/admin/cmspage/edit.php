...
<div class="container">
    ...
    <form method="post" id ="cmsPageForm" action="<?php echo $this->getUrl('save', 'cmsPage', ['id' => $cmsPage->pageId]); ?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <button type="button" name="save" class="btn btn-warning" onclick="object.resetParams().setForm('#cmsPageForm').load();">Save</button>
            </div>
        </div>
