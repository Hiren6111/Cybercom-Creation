    ...
    <table border="2" style="width:100%">
        ...
        <?php foreach($media as $key=>$value){ ?>
            <tr>
                ...
                <td><input type="text" name="label[<?php echo $value->imageId ?>]" value="<?php echo $value->label;?>"></td>		
                <td><input type="radio" name="small" value="<?php echo $value->imageId ?>" <?php if($value->small)echo "checked";?>></td>
                <td><input type="radio" name="thumb" value="<?php echo $value->imageId ?>" <?php if($value->thumb)echo "checked";?>></td>
                <td><input type="radio" name="base" value="<?php echo $value->imageId ?>" <?php if($value->base)echo "checked";?>></td>
                <td><input type="checkbox" name="gallery[<?php echo $value->imageId ?>]" <?php if($value->gallery)echo "checked";?>></td>
                <td><input type="checkbox" name="delete[<?php echo $value->imageId ?>]"></td>
            </tr>
        <?php } endif; ?>
    </table><br>
