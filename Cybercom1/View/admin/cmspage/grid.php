...
<div class="container">
   ...
   <div id="main-content">
       ...
       <a href="<?php echo $this-> getUrl('cmsPageUpdate') ?>" class="btn btn-success" role="button">Add Records</a><br><br>
               ...
               <tbody id="data-table" align="center">
                ...
                <?php foreach ($row->getData() as $value) { ?>
                   ...
                   <tr>
                       ...
                       <td><a href='<?php echo $this->getUrl('cmsPageUpdate', null, ['id' => $value->pageId]) ?>' class="btn btn-warning" role="button">Update</a></td>      
